...
const menuItems = {
  ...
  'super_admin': [
    ...
    { name: 'Clientes', path: '/super-admin/clientes', icon: '🏢' },
    { name: 'Proyectos', path: '/super-admin/proyectos', icon: '📦' },
    { name: 'Sprints', path: '/super-admin/sprints', icon: '📅' },
    { name: 'Actividades', path: '/super-admin/actividades', icon: '✅' },
    { name: 'Cortes', path: '/super-admin/cortes', icon: '💰' },
